...
cheapest, most common integrity failure is _hallucinated evidence_: a claim cites
...
same-model); _support_ is a quality verdict that stays with the cross-model jury
...
made into a cheap pre-gate that catches hallucination _before_ the jury runs and
