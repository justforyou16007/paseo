...
- **Don't auto-trigger `/idea-creator`.** This skill builds the substrate; the user decides when to brainstorm next. Only _suggest_ re-ideation in the final report.
