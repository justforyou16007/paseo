...
if [ -d research-wiki/ ]; then
  ...
  [ -f "$WIKI_SCRIPT" ] || {
    echo "WARN: research-wiki.js not found; depth-read summary delivered, wiki ingest skipped. Fix: export ARIS_REPO, or cp <ARIS-repo>/dist/tools/research-wiki.js tools/." >&2
    WIKI_SCRIPT=""
  }
