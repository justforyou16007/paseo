...
_Example_: Lucid (ASPLOS'23) — 5 gaps mapped to 5 answers.

### Pattern 2: Observation-Driven

O1–O3 from production data → insights → design components.
_Example_: GFS (arXiv 2025) — 3 observations drive 3 components.

### Pattern 3: Contribution List

Numbered contributions in intro, each with §N cross-reference.
_Example_: Blox (EuroSys'24) — 7 contributions; Sia (SOSP'23) — 5 contributions.
