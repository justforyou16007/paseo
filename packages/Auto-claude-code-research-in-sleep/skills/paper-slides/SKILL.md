...
Unlike posters (single page, visual-first), slides tell a **temporal story**: each slide builds on the previous one, with progressive revelation of the research narrative. A good talk makes the audience understand _why this matters_ before showing _what was done_.
...
_[Wait for chair introduction]_
...
→ _Transition_: "So what's our key insight?"
...
→ _Transition_: "Let me walk you through how this works."
