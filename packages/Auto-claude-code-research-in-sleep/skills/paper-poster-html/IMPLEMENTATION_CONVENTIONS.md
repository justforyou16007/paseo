...
```css
--fs-1: calc(9 * var(--u)); /* 微标签 */
--fs-2: calc(10 * var(--u)); /* 小 caption */
--fs-3: calc(11 * var(--u)); /* caption/表格 */
--fs-4: calc(12 * var(--u)); /* 正文 */
--fs-5: calc(13 * var(--u)); /* 公式/强调 */
--fs-6: calc(15 * var(--u)); /* 副标题 */
--fs-7: calc(16 * var(--u)); /* 节标题 */
--fs-8: calc(22 * var(--u)); /* banner 数字 */
...
```json
{
  ...
  "figures": [
    {
      "asset_id": "fig_method",
      "file": "assets/paper_figures/fig_method.png",
      "from_paper": true,
      "page": 3,
      "bbox": [72.0, 100.0, 520.0, 380.0],
      "dpi": 350,
      "sha256": "…",
      "natural_px": [2178, 1362],
      "caption_hint": "Figure 2: …"
    }
  ]
}
```
