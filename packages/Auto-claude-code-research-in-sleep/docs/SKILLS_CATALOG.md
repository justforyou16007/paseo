...
| Skill                                                          | Role                                                                                                                                                                                                                                                                                                                                                                                  | Requires                            |
| -------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- |
| [`/experiment-env-manager`](../skills/experiment-env-manager/SKILL.md) | Sole entry point for experiment environment lifecycle — baseline creation, runtime error handling, on-demand audit; dispatches env-configuration for generation and env-audit for validation; repair loop until pass or human intervention | Codex MCP |
| [`/experiment-env-configuration`](../skills/experiment-env-configuration/SKILL.md) | Configure experiment environment once, freeze prepare→run→collect→analyze into a reusable project-local skill with 7 atomic scripts; cross-model audited                                                                                                                                                                                                                              | Codex MCP                           |
| [`/experiment-env-audit`](../skills/experiment-env-audit/SKILL.md) | Cross-model audit of experiment environment config — checks command provenance, metric agreement, failure detectability, environment reachability, dynamic modification simulation; dispatched exclusively by env-manager | Codex MCP |
...
| [`/analysis-comparison`](../skills/analyze-results-tools/analysis-comparison/SKILL.md) | Cross-experiment comparison tables, multi-seed statistics, sweep trends, outlier flags (Type-A)                                                                                                                                                                                                                                                                                    | None                                || [`/experiment-queue`](../skills/experiment-queue/SKILL.md)     | SSH job queue for multi-seed / multi-config sweeps — OOM retry, stale-screen cleanup, wave gating, crash-safe state                                                                                                                                                                                                                                                                   | SSH access                          |
