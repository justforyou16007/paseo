...
| [`/experiment-env-audit`](../skills/experiment-env-audit/SKILL.md) | Cross-model audit of experiment environment config — checks command provenance, metric agreement, failure detectability, environment reachability; reusable by any workflow skill when environment changes | Codex MCP |
...
| [`/research-setup`](../skills/research-setup/SKILL.md)           | Interactive Q&A setup wizard for new ARIS research projects — bootstraps CLAUDE.md, RESEARCH_BRIEF.md, research-wiki; delegates experiment environment to `/experiment-env-configuration`; bilingual (en/zh), resumable          | None (pure Markdown + TS helpers)       |
