...
```json
{ "type": "tool_use", "name": "get_weather", "input": { "city": "Shanghai", "unit": "celsius" } }
```
...
// v0.3-style example (field names per the official spec; only key fields shown)
{
  ...
  "additionalInterfaces": [
    // The same agent can expose multiple transports
  ...
  "skills": [{ "id": "buy", "name": "Buy item", "description": "..." }],
  "securitySchemes": {
    // v0.3: aligned with OpenAPI's schemes shape
