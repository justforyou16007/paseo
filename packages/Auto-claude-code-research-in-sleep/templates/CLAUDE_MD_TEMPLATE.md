...
> Generated by `/research-setup` from user-provided information. Lists reference
> materials, domain knowledge, and auxiliary skills that the research loop
> should consult during idea discovery and review.

```yaml
skills: []                    # e.g., ["/comm-lit-review", "/formula-derivation"]
documents: []                 # e.g., ["papers/baseline_paper.pdf", "docs/domain_notes.md"]
knowledge: []                 # e.g., ["model must fit in 24GB VRAM", "use XXX metric"]
```
