...
- boolean discriminated-union branches must emit `case true:`/`case false:`, not string comparisons
...
- ARIS wiki, wiki entity, and experiments response envelopes validate with boolean `ok` discriminator
